...
def main():
    ...
    while ret is True:
        ...
        ret_left, corners_left = cv2.findChessboardCorners(gray_left, (7, 7), None)
        ret_right, corners_right = cv2.findChessboardCorners(gray_right, (7, 7), None)
        ...
        if ret_left == True:
            ...
            frame_left = cv2.drawChessboardCorners(frame_left, (7, 7), corners_left_2, ret_left)
        ...
        if ret_right == True:
            ...
            # Draw and display the corners
            frame_right = cv2.drawChessboardCorners(frame_right, (7, 7), corners_right_2, ret_right)
